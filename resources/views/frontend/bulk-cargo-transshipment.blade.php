                ...
                <div id="content_block">
                    <div id="full_screen">
                        <div class="page_fullscren">
                            ...
                            <div class="ill_top">
                                @include('frontend.modules.svg.cargo_transhipment')
                            </div>
                    ...
                    <div id="under">
                        ...
                        <div class="statistics page animate_block">
                            <div class="item item_animate">
                                <div class="top">@lang('frontend/services.bulk-cargo-transshipment.stats.1.top')</div>
                                <div class="bot">@lang('frontend/services.bulk-cargo-transshipment.stats.1.bot')</div>
                            </div>
                            <div class="item item_animate">
                                <div class="top">@lang('frontend/services.bulk-cargo-transshipment.stats.2.top')</div>
                                <div class="bot">@lang('frontend/services.bulk-cargo-transshipment.stats.2.bot')</div>
                            </div>
                            <div class="item item_animate">
                                <div class="top">@lang('frontend/services.bulk-cargo-transshipment.stats.3.top')</div>
                                <div class="bot">@lang('frontend/services.bulk-cargo-transshipment.stats.3.bot')</div>
                            </div>
                            <div class="item item_animate">
                                <div class="top">@lang('frontend/services.bulk-cargo-transshipment.stats.4.top')</div>
                                <div class="bot">@lang('frontend/services.bulk-cargo-transshipment.stats.4.bot')</div>
                            </div>
                            <div class="item item_animate">
                                <div class="top">@lang('frontend/services.bulk-cargo-transshipment.stats.5.top')</div>
                                <div class="bot">@lang('frontend/services.bulk-cargo-transshipment.stats.5.bot')</div>
                            </div>
                        </div>

                        <div class="image_page">
                            <div class="top"><img src="/frontend/img/gallery_duga.svg" width="1335" height="31" alt=""></div>
                            <img src="/frontend/img/tresh/photo_2019.jpg" alt="">
