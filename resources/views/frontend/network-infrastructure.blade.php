                                    ...
                                    <div class="left animate_block">
                                        <div class="item_animate">
                                            <a href="{{lang_route('services',['service'=>'handling-and-storage'])}}" class="title">
                                                {!! $services->where('slug','network-infrastructure')->first()->translate('title',session('db_lang')) !!}
                                            </a>
                                            <div class="description_page">
                                                {!! $services->where('slug','network-infrastructure')->first()->translate('excerpt',session('db_lang')) !!}
                                            </div>
                                            <a href="{{lang_route('services',['service'=>'network-infrastructure'])}}" class="link">@lang('frontend/index.captions.more')</a>
